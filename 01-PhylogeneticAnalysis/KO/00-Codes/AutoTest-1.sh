...
#Sources
PATH_ONEKP="../../../Resources/02-OneKP/Extracted/OneKP-Nonseed-merged.fasta"
PATH_GENOME="../../../Resources/01-Genomes/Combined/AllGenomes-merged.fasta"
PATH_DONG="../../../Resources/03-Dong2022/Combined/Dong42-merged.fasta"
...
cd $outDir
iqtree -nt AUTO -ntmax 8 -s ./03-Candidates-all_FFTNS2.${ratio}.phy -m TEST -mset phyml -fast -alrt 1000 --prefix ./04-Candidates-all_FFTNS2_${ratio}
